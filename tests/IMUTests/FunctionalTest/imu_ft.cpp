...
TEST_F(imu_ft, imu_start)
{
    ...
    config_all_running.color_mode_info.mode_id = K4A_COLOR_RESOLUTION_2160P;
    config_all_running.depth_mode_info.mode_id = K4A_DEPTH_MODE_NFOV_UNBINNED;
    config_all_running.fps_mode_info.mode_id = K4A_FRAMES_PER_SECOND_30;
    ...
    config = config_all_running;
    config.depth_mode_info.mode_id = K4A_DEPTH_MODE_OFF;
    ASSERT_EQ(K4A_RESULT_SUCCEEDED, k4a_device_start_cameras(m_device, &config));
    ASSERT_EQ(K4A_RESULT_SUCCEEDED, k4a_device_start_imu(m_device));
    k4a_device_stop_cameras(m_device);
    k4a_device_stop_imu(m_device);
