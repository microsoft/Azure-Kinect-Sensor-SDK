...
TEST_F(executables_ft, green_screen_single_cam)
{
    ...
    ASSERT_EQ(run_and_record_executable(green_screen_path + " 1 9 6 22 1000 4000 2 30 5", green_screen_out),
              EXIT_SUCCESS);
}
...
TEST_F(executables_ft, green_screen_double_cam)
{
    ...
    ASSERT_EQ(run_and_record_executable(green_screen_path + " 2 9 6 22 1000 4000 2 30 5", green_screen_out),
              EXIT_SUCCESS);
