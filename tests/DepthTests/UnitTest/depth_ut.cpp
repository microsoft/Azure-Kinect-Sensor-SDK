...
public:
    ...
    MOCK_CONST_METHOD2(depthmcu_depth_set_capture_mode,
                       k4a_result_t(depthmcu_t depthmcu_handle, k4a_depth_mode_info_t depth_mode_info));

    MOCK_CONST_METHOD2(depthmcu_depth_set_fps, k4a_result_t(depthmcu_t depthmcu_handle, k4a_fps_mode_info_t fps_mode_info));
...
{
    return g_MockDepthMcu->depthmcu_depth_set_capture_mode(depthmcu_handle, depth_mode_info);
}

k4a_result_t depthmcu_depth_set_fps(depthmcu_t depthmcu_handle, k4a_fps_mode_info_t fps_mode_info)
{
    return g_MockDepthMcu->depthmcu_depth_set_fps(depthmcu_handle, fps_mode_info);
}
