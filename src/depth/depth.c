...
static k4a_version_t g_min_fw_version_rgb = { 1, 5, 92 };             // 1.5.78
static k4a_version_t g_min_fw_version_depth = { 1, 5, 66 };           // 1.5.60
static k4a_version_t g_min_fw_version_audio = { 1, 5, 14 };           // 1.5.13
