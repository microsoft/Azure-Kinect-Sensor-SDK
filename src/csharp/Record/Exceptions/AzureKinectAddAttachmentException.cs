...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectAddAttachmentException"/> class.
        /// </summary>
        public AzureKinectAddAttachmentException()
        {
        }
        ...
        public AzureKinectAddAttachmentException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectAddAttachmentException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectAddAttachmentException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectAddAttachmentException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectAddAttachmentException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer(LogLevel.Warning, Logger.LogProvider, RecordLogger.LogProvider))
            {
                ...
                {
                    throw new AzureKinectAddAttachmentException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
