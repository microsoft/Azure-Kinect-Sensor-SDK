...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectAddCustomVideoTrackException"/> class.
        /// </summary>
        public AzureKinectAddCustomVideoTrackException()
        {
        }
        ...
        public AzureKinectAddCustomVideoTrackException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectAddCustomVideoTrackException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectAddCustomVideoTrackException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectAddCustomVideoTrackException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectAddCustomVideoTrackException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer(LogLevel.Warning, Logger.LogProvider, RecordLogger.LogProvider))
            {
                ...
                {
                    throw new AzureKinectAddCustomVideoTrackException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
