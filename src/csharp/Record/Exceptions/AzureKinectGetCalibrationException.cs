...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class AzureKinectGetCalibrationException : AzureKinectRecordException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectGetCalibrationException"/> class.
        /// </summary>
        public AzureKinectGetCalibrationException()
        {
        }
        ...
        public AzureKinectGetCalibrationException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectGetCalibrationException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectGetCalibrationException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectGetCalibrationException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectGetCalibrationException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer(LogLevel.Warning, Logger.LogProvider, RecordLogger.LogProvider))
            {
                ...
                {
                    throw new AzureKinectGetCalibrationException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
