...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectGetCaptureException"/> class.
        /// </summary>
        public AzureKinectGetCaptureException()
        {
        }
        ...
        public AzureKinectGetCaptureException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectGetCaptureException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectGetCaptureException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectGetCaptureException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectGetCaptureException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer(LogLevel.Warning, Logger.LogProvider, RecordLogger.LogProvider))
            {
                ...
                {
                    throw new AzureKinectGetCaptureException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
