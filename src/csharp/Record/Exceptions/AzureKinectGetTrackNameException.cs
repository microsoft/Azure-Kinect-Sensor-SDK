...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectGetTrackNameException"/> class.
        /// </summary>
        public AzureKinectGetTrackNameException()
        {
        }
        ...
        public AzureKinectGetTrackNameException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectGetTrackNameException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectGetTrackNameException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectGetTrackNameException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectGetTrackNameException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer())
            {
                ...
                {
                    throw new AzureKinectGetTrackNameException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
