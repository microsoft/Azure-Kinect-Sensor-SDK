...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectGetTagException"/> class.
        /// </summary>
        public AzureKinectGetTagException()
        {
        }
        ...
        public AzureKinectGetTagException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectGetTagException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectGetTagException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectGetTagException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectGetTagException"/> if the result of the function
        /// is not a success.
        /// </summary>
