...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectAddCustomSubtitleTrackException"/> class.
        /// </summary>
        public AzureKinectAddCustomSubtitleTrackException()
        {
        }
        ...
        public AzureKinectAddCustomSubtitleTrackException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectAddCustomSubtitleTrackException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectAddCustomSubtitleTrackException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectAddCustomSubtitleTrackException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectAddCustomSubtitleTrackException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer(LogLevel.Warning, Logger.LogProvider, RecordLogger.LogProvider))
            {
                ...
                {
                    throw new AzureKinectAddCustomSubtitleTrackException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
