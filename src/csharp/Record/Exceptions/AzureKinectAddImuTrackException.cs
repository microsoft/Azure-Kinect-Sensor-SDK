...
namespace Microsoft.Azure.Kinect.Sensor.Record.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class AzureKinectAddImuTrackException : AzureKinectRecordException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKinectAddImuTrackException"/> class.
        /// </summary>
        public AzureKinectAddImuTrackException()
        {
        }
        ...
        public AzureKinectAddImuTrackException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public AzureKinectAddImuTrackException(string message, Exception innerException)
        ...
        /// </param>
        protected AzureKinectAddImuTrackException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// </param>
        protected AzureKinectAddImuTrackException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectAddImuTrackException"/> if the result of the function
        /// is not a success.
        /// </summary>
            ...
            where T : System.Enum
        {
            using (LoggingTracer tracer = new LoggingTracer())
            {
                ...
                {
                    throw new AzureKinectAddImuTrackException($"result = {result}", tracer.LogMessages);
                }
            }
        }
    }
