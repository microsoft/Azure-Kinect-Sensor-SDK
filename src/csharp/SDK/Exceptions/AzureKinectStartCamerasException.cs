...
namespace Microsoft.Azure.Kinect.Sensor
{
    ...
    public class AzureKinectStartCamerasException : AzureKinectException
    {
        ...
        /// </param>
        protected AzureKinectStartCamerasException(string message, ICollection<LogMessage> logMessages)
            : base(message, logMessages)
        {
        }

        /// <summary>
        /// Throws an <see cref="AzureKinectStartCamerasException"/> if the result of the function
        /// is not a success.
        /// </summary>
