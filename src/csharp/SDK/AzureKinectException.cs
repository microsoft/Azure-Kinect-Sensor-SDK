...
namespace Microsoft.Azure.Kinect.Sensor
{
    ...
    public class AzureKinectException : Exception
    {
        ...
        public AzureKinectException(string message) : base(message) { }
        ...
        public AzureKinectException(string message, Exception innerException) : base(message, innerException) { }
        ...
        protected AzureKinectException(SerializationInfo info, StreamingContext context) : base(info, context) { }
