...
{
    return TRACE_CALL(transformation_3d_to_3d(calibration,
                                              source_point3d_in_mm->v,
                                              source_camera,
                                              target_camera,
                                              target_point3d_in_mm->v));
}
...
k4a_result_t k4a_calibration_2d_to_3d(const k4a_calibration_t *calibration,
                                      ...
                                      int *valid)
{
    return TRACE_CALL(transformation_2d_to_3d(calibration,
                                              source_point2d->v,
                                              source_depth_in_mm,
                                              source_camera,
                                              target_camera,
                                      ...
                                      int *valid)
{
    return TRACE_CALL(transformation_3d_to_2d(
        calibration, source_point3d_in_mm->v, source_camera, target_camera, target_point2d->v, valid));
}
