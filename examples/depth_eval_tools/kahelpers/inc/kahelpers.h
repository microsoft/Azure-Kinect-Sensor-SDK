...
namespace kahelpers
{
	...
	float get_gray_gamma_img(const cv::Mat &inImg, cv::Mat &outImg, float gamma = 0.5f, float maxInputValue = 5000.0, float percentile = 99.0);
	...
	void get_images(k4a::playback &playback, int timestamp,
		...
		bool single = false, bool get_ir = true, bool get_depth = true, bool get_color = true);
