...
{
public:
    explicit K4AInfraredImageConverter(uint32_t depth_mode_id) : K4ADepthImageConverterBase<K4A_IMAGE_FORMAT_IR16, K4ADepthPixelColorizer::ColorizeGreyscale>(depth_mode_id, GetIrLevels(depth_mode_id)){};
