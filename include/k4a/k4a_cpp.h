...
namespace k4a
{
    ...
    struct calibration : public k4a_calibration_t
    {
        ...
        {
            int intValid = 0;
            k4a_result_t result = k4a_calibration_2d_to_3d(this, &source_point2d, source_depth, source_camera, target_camera, target_point3d, &intValid);
        ...
        {
            k4a_float3_t target_point3d;
            k4a_result_t result = convert_2d_to_3d(source_point2d, source_depth, source_camera, target_camera, &target_point3d, valid);

            check_result(result);
            return target_point3d;
        }

        k4a_result_t convert_3d_to_2d(
            const k4a_float3_t& source_point3d,
            k4a_calibration_type_t source_camera,
            k4a_calibration_type_t target_camera,
        ...
        {
            int intValid = 0;
            k4a_result_t result = k4a_calibration_3d_to_2d(this, &source_point3d, source_camera, target_camera, target_point2d, &intValid);
        ...
        {
            int intValid = 0;
            k4a_result_t result = k4a_calibration_2d_to_2d(this, &source_point2d, source_depth, source_camera, target_camera, target_point2d, &intValid);
        ...
        {
            k4a_float2_t target_point2d;
            k4a_result_t result = convert_2d_to_2d(source_point2d, source_depth, source_camera, target_camera, &target_point2d, valid);

            check_result(result);
            return target_point2d;
        }

        static k4a_result_t get_from_raw(
            const char* raw_calibration,
            size_t raw_calibration_size,
            k4a_depth_mode_t depth_mode,
            k4a_color_resolution_t color_resolution,
            calibration& calib)
        {
            return k4a_calibration_get_from_raw(const_cast<char*>(raw_calibration), raw_calibration_size, depth_mode, color_resolution, &calib);
        }

        static k4a_result_t get_from_raw(
            const uint8_t* raw_calibration,
            size_t raw_calibration_size,
            k4a_depth_mode_t depth_mode,
            k4a_color_resolution_t color_resolution,
            calibration& calib)
        {
            return get_from_raw(reinterpret_cast<const char*>(raw_calibration), raw_calibration_size, depth_mode, color_resolution, calib);
        }

        static k4a_result_t get_from_raw(
            const std::vector<uint8_t>& raw_calibration,
            k4a_depth_mode_t depth_mode,
            k4a_color_resolution_t color_resolution,
            calibration& calib)
        {
            return get_from_raw(reinterpret_cast<const char*>(raw_calibration.data()), raw_calibration.size(), depth_mode, color_resolution, calib);
        }

        static calibration get_from_raw(
            const char* raw_calibration,
            size_t raw_calibration_size,
            k4a_depth_mode_t depth_mode,
            k4a_color_resolution_t color_resolution)
    ...
    public:
        ...
        transformation(k4a_transformation_t handle = nullptr)
            : m_handle(handle)
        {
        }
        ...
        {
            return k4a_transformation_depth_image_to_color_camera(m_handle, depth_image.handle(), transformed_depth_image.handle());
        }

        k4a_result_t color_image_to_depth_camera(const image& depth_image, const image& color_image, image& transformed_color_image) const
        {
            return k4a_transformation_color_image_to_depth_camera(m_handle, depth_image.handle(), color_image.handle(), transformed_color_image.handle());
        }

        k4a_result_t depth_image_to_point_cloud(const image& depth_image, k4a_calibration_type_t camera, image& xyz_image) const
        {
            return k4a_transformation_depth_image_to_point_cloud(m_handle, depth_image.handle(), camera, xyz_image.handle());
        }
