 ...
 *
 * Handles are created with k4a_device_get_transformation_context() and closed with
 * k4a_transformation_context_release(). Invalid handles are set to 0.
 *
 * \xmlonly
 * <requirements>
 *   <requirement name="Header">k4atypes.h (include k4a/k4a.h)</requirement>
...
/** Calibration type representing device calibration. It contains (1) the depth and color camera's intrinsic
