...
typedef void *usb_command_handle_t;
 ...
 *    A pointer to write the opened usb_command_handle_t device handle to
 *
 ...
 * \ref usb_cmd_destroy
 */
k4a_result_t usb_cmd_create(usb_command_device_type_t DeviceType,
                            uint8_t device_index,
                            usb_command_handle_t *usb_handle);

void usb_cmd_destroy(usb_command_handle_t usb_handle);

// Read command
k4a_result_t usb_cmd_read(usb_command_handle_t usb_handle,
                          uint32_t cmd,
                          uint8_t *p_cmd_data,
...
// Write command
k4a_result_t usb_cmd_write(usb_command_handle_t usb_handle,
                           uint32_t cmd,
                           uint8_t *p_cmd_data,
                           size_t cmd_data_size,
                           uint8_t *p_data,
...
k4a_result_t usb_cmd_write_with_status(usb_command_handle_t usb_handle,
                                       uint32_t cmd,
                                       uint8_t *p_cmd_data,
                                       size_t cmd_data_size,
                                       uint8_t *p_data,
...
k4a_result_t usb_cmd_stream_register_cb(usb_command_handle_t p_handle,
                                        usb_cmd_stream_cb_t *frame_ready_cb,
                                        void *context);

k4a_result_t usb_cmd_stream_start(usb_command_handle_t usb_handle, size_t payload_size);

k4a_result_t usb_cmd_stream_stop(usb_command_handle_t usb_handle);
